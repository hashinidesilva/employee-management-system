...
export class EmployeeService{
    ...
    public getEmployeeById(id){
        return this.http.get("http://localhost:8080/search?id="+id)
    }
    ...
    public getEmployeeByName(name){
        return this.http.get("http://localhost:8080/searchName?name="+name)
    }

    public updateEmployee(employee){
        return this.http.put("http://localhost:8080/update",employee,{responseType: 'text' as 'json'});
    }
